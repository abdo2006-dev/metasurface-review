...
| A3 | "FIM surveys do not exist." | S1, S10 | ‼ **FALSIFIED 3 September 2026 — withdrawn, not reworded** | ~~"Our searches did not locate a review or survey dedicated to flexible intelligent metasurfaces…"~~ **A FIM-dedicated overview article exists and the search missed it:** Magbool, Kumar, Di Renzo and Flanagan, *Beyond the Limits of Rigid Arrays*, arXiv:2603.11886, public since 12 March 2026 — five months before the 17 August search that was conducted to answer this exact question. **No absence claim of this form may be made anywhere in the manuscript.** The manuscript now cites the article and states what it does and does not supply (§1). The caveat this row already carried — that a non-protocol-driven search yields a search outcome and not an established absence — was the correct caveat, and it was not enough: the outcome itself was wrong. What survives, and is separately evidenced, is **A4**, which is a property of three named documents rather than of the field. |
