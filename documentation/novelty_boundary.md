...
⚠ **Wording constraint B (18 August 2026, `CHANGELOG.md` CH-100; renumbered by the v0.24 taxonomy rebuild, corrected here 22 August 2026).** Every count must name the axis it counts. Three maxima exist and differ: quantitatively evidenced stages **6** (BAI-22 and LI-25); measured stage durations **4** (BAI-22 alone); stages carrying any duration information **6** (LI-25 alone). **Forbidden: any stage count that does not say which of the three it is, and any count of five, which followed from the pre-v0.24 taxonomy.** Required form: "no reviewed platform measures the duration of more than four of the ten stages, and the platform reaching four has no radio-frequency layer."
