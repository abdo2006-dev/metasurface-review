...
Axis B (timing status):          ·T   fully delimited (identifiable start AND end event)
                                 ·(T) partially delimited (start, end, or separation
                                      from an adjacent stage unresolved; or a duration
                                      attributed to the stage from an aggregate interval)
                                 unmarked -- untimed
